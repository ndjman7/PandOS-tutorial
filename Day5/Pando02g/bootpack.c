...
void HariMain(void)
{
    ...
    putfonts8_asc(binfo->vram, binfo->scrnx,  8,  8, COL8_FFFFFF, (unsigned char *)"ABC 123");
    putfonts8_asc(binfo->vram, binfo->scrnx, 31, 31, COL8_000000, (unsigned char *)"PandOS.");
    putfonts8_asc(binfo->vram, binfo->scrnx, 30, 30, COL8_FFFFFF, (unsigned char *)"PandOS.");

    sprintf(s, "scrnx = %d", binfo->scrnx);
    putfonts8_asc(binfo->vram, binfo->scrnx, 16, 64, COL8_FFFFFF, (unsigned char *)s);
